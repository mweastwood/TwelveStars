...
void main() {
  test('generate lectionary JSON', () async {
                ...
                if (citation != null && citation.trim().isNotEmpty) {
                  ...
                  if (parsed != null) {
                    ...
                    if (matchedBook.bookNumber != 0) {
                      ...
                      print(
                        'Warning: Book not matched for citation "$citation" on $dateStr',
                      );
                    }
                  }
                }
    ...
    outputList.sort((a, b) {
      ...
      return (a['reading_type'] as String).compareTo(
        b['reading_type'] as String,
      );
    });
