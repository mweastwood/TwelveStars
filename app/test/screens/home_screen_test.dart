  ...
  group('HomeScreen Widget', () {
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        expect(
          find.byKey(const Key('drawer_confirmation_tile')),
          findsOneWidget,
        );

        await tester.tap(find.byKey(const Key('drawer_confirmation_tile')));
        await tester.pumpAndSettle();

        expect(find.byType(ConfirmationDiscernmentScreen), findsOneWidget);
      },
    );
