    ...
    translations: {
      PrayerLanguage.english: const [
        ...
        PrayerTranslation(
          ...
          sourceName: 'English Language Liturgical Consultation (ELLC)',
          sourceUrl: 'https://en.wikipedia.org/wiki/Lord%27s_Prayer',
        ),
      ],
      PrayerLanguage.spanish: const [
        PrayerTranslation(
          title: 'Padre Nuestro',
      ...
      PrayerLanguage.french: const [
        PrayerTranslation(
          title: 'Notre Père',
          subtitle: "L'Oraison Dominicale (Nouveau)",
          text:
              'Notre Père, qui es aux cieux,\nque ton Nom soit sanctifié,\nque ton Règne vienne,\nque ta volonté soit faite,\nsur la terre comme au ciel.\n\nDonne-nous aujourd’hui notre pain de ce jour,\npardonne-nous nos offenses,\ncomme nous pardonnons aussi à ceux qui nous ont offensés,\net ne nous laisse pas entrer en tentation,\nmais délivre-nous du mal.\n\nAmen.',
          sourceName: 'AELF / Wikipedia',
          sourceUrl: 'https://fr.wikipedia.org/wiki/Notre_P%C3%A8re',
        ),
        PrayerTranslation(
          title: 'Notre Père',
          subtitle: "L'Oraison Dominicale (Traditionnel)",
          text:
              'Notre Père, qui es aux cieux,\nque ton Nom soit sanctifié,\nque ton Règne vienne,\nque ta volonté soit faite,\nsur la terre comme au ciel.\n\nDonne-nous aujourd’hui notre pain de ce jour,\npardonne-nous nos offenses,\ncomme nous pardonnons aussi à ceux qui nous ont offensés,\net ne nous soumets pas à la tentation,\nmais délivre-nous du mal.\n\nAmen.',
          sourceName:
              'Compendium du Catéchisme de l’Église Catholique (Vatican)',
          sourceUrl:
              'https://www.vatican.va/archive/compendium_ccc/documents/archive_2005_compendium-ccc_fr.html',
        ),
      ],
      PrayerLanguage.italian: const [
        PrayerTranslation(
          title: 'Padre Nostro',
      ...
      PrayerLanguage.vietnamese: const [
        PrayerTranslation(
          title: 'Kinh Lạy Cha',
      ...
      PrayerLanguage.traditionalChinese: const [
        PrayerTranslation(
          title: '天主經',
  ...
  Prayer(
    ...
    translations: {
      PrayerLanguage.english: const [
        PrayerTranslation(
          title: 'Hail Mary',
          subtitle: 'Ave Maria (Traditional)',
          text:
        ...
        PrayerTranslation(
          title: 'Hail Mary',
          subtitle: 'Ave Maria (Modern)',
          text:
              'Hail Mary, full of grace,\nthe Lord is with you.\nBlessed are you among women,\nand blessed is the fruit of your womb, Jesus.\n\nHoly Mary, Mother of God,\npray for us sinners,\nnow and at the hour of our death.\n\nAmen.',
          sourceName: 'Wikipedia',
          sourceUrl: 'https://en.wikipedia.org/wiki/Hail_Mary',
        ),
      ],
      PrayerLanguage.spanish: const [
        PrayerTranslation(
