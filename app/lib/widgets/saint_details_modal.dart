...
/// Opens an interactive modal bottom sheet displaying complete details and biography for [saint].
void showSaintDetailsModal(BuildContext context, Saint saint) {
